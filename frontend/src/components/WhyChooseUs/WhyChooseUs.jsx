  ...
  return (
    <section className="container mx-auto px-10 md:px-8 lg:px-6">
      ...
      <div className=" mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
        ...
        <div className="bg-accentOne py-4 px-9 relative rounded-3xl">
          ...
          <h1 className="text-lg font-medium font-bai">
            Real-Time Notification:-
          </h1>
          <p className="font-bai">
            Stay updated with instant notifications for class schedules,
            assignment deadlines, grades, and more. Both teachers and students
            receive important alerts in real-time, ensuring no one misses a
            beat.
          </p>
        </div>
        {/* free demo classes */}
